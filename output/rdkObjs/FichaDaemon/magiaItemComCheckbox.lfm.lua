...
local function constructNew_frmMagiaItemComCheckbox()
    ...
    obj.imageCheckBox1:setImageChecked("/FichaDaemon/images/checkbox1_checked.png");
    obj.imageCheckBox1:setImageUnchecked("/FichaDaemon/images/checkbox1_unchecked.png");
