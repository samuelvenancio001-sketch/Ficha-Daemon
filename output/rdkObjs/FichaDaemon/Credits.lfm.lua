...
local function constructNew_frmTemplateCreditos()
    ...
    obj.image1:setSRC("/FichaDaemon/images/RPGmeister.jpg");
    ...
    obj.label4:setText("Mizuka");
    obj.label4:setHorzTextAlign("center");
    obj.label4:setMargins({top=5});
    ...
    obj.label5:setText("Megas1200");
    obj.label5:setHorzTextAlign("center");
    obj.label5:setMargins({top=5});
    obj.label5:setName("label5");

    obj.layout2 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout2:setParent(obj.scrollBox1);
    obj.layout2:setLeft(0);
    obj.layout2:setTop(430);
    obj.layout2:setWidth(200);
    obj.layout2:setHeight(190);
    ...
    obj.dataLink5:setField("coresAtivas");
    obj.dataLink5:setDefaultValue("false");
    ...
    obj.label14:setWidth(500);
    obj.label14:setHeight(20);
    obj.label14:setText("Creditos de icones:");
    ...
    obj.label15:setTop(262);
    obj.label15:setWidth(600);
    obj.label15:setHeight(20);
    obj.label15:setText("Icone do escudo (Resistido): Flaticon - www.flaticon.com");
