...
local function constructNew_frmEquipamentoItemDefesa()
    ...
    obj.GridCampoSolido4:setMinScaledWidth(70);
    obj.GridCampoSolido4:setMinWidth(70);
    ...
    obj.edtGridCampoSolido4:setField("pericia");
    ...
    obj.labGridCampoSolido4:setText("Pericia %");
    ...
    obj.edtGridCampoSolido5:setField("caBonus");
    ...
    obj.labGridCampoSolido5:setText("@@DnD5e.tab.equipament.defend.lab.ca");
    ...
    obj.labGridCampoSolido6:setText("INICIATIVA");
